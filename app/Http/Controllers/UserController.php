  ...
  public function index(Request $request)
{
  ...
  public function editprofile(Request $request)
  {
    ...
    if ($request->hasFile('profile')) {
      ...
      if ($userDetail['avatar'] && Storage::disk('public')->exists('uploads/avatar/' . $userDetail['avatar'])) {
        Storage::disk('public')->delete('uploads/avatar/' . $userDetail['avatar']);
      }

      // Store new avatar
      $request->file('profile')->storeAs('uploads/avatar', $fileNameToStore, 'public');
