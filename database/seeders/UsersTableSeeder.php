...
class UsersTableSeeder extends Seeder
{
  ...
  public function run()
  {
    $arrPermissions = [
      ...
      [
        'name' => 'manage business mission',
        'guard_name' => 'web',
        'created_at' => date('Y-m-d H:i:s'),
        'updated_at' => date('Y-m-d H:i:s')
      ],
      [
        'name' => 'create business mission',
        'guard_name' => 'web',
        'created_at' => date('Y-m-d H:i:s'),
        'updated_at' => date('Y-m-d H:i:s')
      ],
      [
        'name' => 'edit business mission',
        'guard_name' => 'web',
        'created_at' => date('Y-m-d H:i:s'),
        'updated_at' => date('Y-m-d H:i:s')
      ],
      [
        'name' => 'delete business mission',
        'guard_name' => 'web',
        'created_at' => date('Y-m-d H:i:s'),
        'updated_at' => date('Y-m-d H:i:s')
      ],
    ...
    $companyPermissions = [
      ...
      'view excuse',
      'approve excuse',
      'manage business mission',
      'create business mission',
      'edit business mission',
      'delete business mission',
      'view business mission',
      'approve business mission',
      'manage loan',
      'create loan',
      'edit loan',
      'delete loan',
    ...
    foreach ($companyPermissions as $perm) {
      if (!$companyRole->hasPermissionTo($perm)) {
    ...
    if (!$company->hasRole($companyRole->name)) {
    ...
    foreach ($accountantPermission as $perm) {
      if (!$accountantRole->hasPermissionTo($perm)) {
    ...
    if (!$employee->hasRole($employeeRole->name)) {
    ...
    foreach ($clientPermission as $perm) {
      if (!$clientRole->hasPermissionTo($perm)) {
        $clientRole->givePermissionTo($perm);
      }
    }
    ...
    if (!$client->hasRole($clientRole->name)) {
