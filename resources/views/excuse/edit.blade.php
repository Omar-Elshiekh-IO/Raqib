{{ Form::model($excuse, ['route' => ['excuse.update', $excuse->id], 'method' => 'PUT', 'class' => 'needs-validation', 'novalidate']) }}
    ...
    <div class="row">
        ...
        <div class="col-md-12">
            <div class="form-group">
                <div class="form-check">
                    <input class="form-check-input" type="checkbox" value="1" id="with_deduction" name="with_deduction" {{ old('with_deduction', $excuse->with_deduction) ? 'checked' : '' }}>
        ...
        <div class="col-md-12" id="deduction_amount_group" style="display:none;">
            <div class="form-group">
                ...
                {{ Form::number('deduction_amount', old('deduction_amount', $excuse->deduction_amount), ['class' => 'form-control', 'step' => '0.01', 'min' => '0', 'placeholder' => __('Enter Deduction Amount')]) }}
            </div>
        </div>
    </div>
</div>
...
$(document).ready(function() {
    ...
    $(document).on('change', '#with_deduction', toggleDeductionAmount);
});
</script> 