    {{Form::open(array('url'=>'work-shift','method'=>'post', 'class'=>'needs-validation', 'novalidate'))}}
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="form-group">
                ...
                {{Form::text('title',null,array('class'=>'form-control','placeholder'=>__('Enter work shift title'),'required'=> 'required'))}}
            </div>
            <div class="form-group">
                {{Form::label('from',__('From'),['class'=>'form-label'])}}<x-required></x-required>
                {{Form::time('from',null,array('class'=>'form-control','placeholder'=>__('Enter work shift start time'),'required'=> 'required'))}}
            </div>
            <div class="form-group">
                {{Form::label('to',__('To'),['class'=>'form-label'])}}<x-required></x-required>
                {{Form::time('to',null,array('class'=>'form-control','placeholder'=>__('Enter work shift end time'),'required'=> 'required'))}}
            </div>
            <div class="form-group">
              <div class="form-group">
